...
export default function RegisterPage() {
  ...
  return (
    <>
      <SEOHead title="Create a Mahjong Profile | Nine Gates Mahjong" description="Register a free Nine Gates Mahjong profile for ratings, Hall of Fame wins, daily streaks, and future events." canonical="https://ninegatesmahjong.com/register" />
      <main className="account-page">
        <form onSubmit={async (event) => {
          ...
          <button className="btn-primary" type="submit">Create free profile</button>
